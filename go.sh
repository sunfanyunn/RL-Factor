...
do
TMPDIR=/home/horde/projects/RL-Factor/tmp python rl_trainer.py --exp factor-baselines-v1  --env_name $env_name --env_id $env_id --algo $algo --wandb --num_gpus 1 --num_workers 40 --results_dir $results_dir --factor
done
