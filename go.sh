...
for algo in dreamerv3 dqn ppo impala dreamerv3 
do
TMPDIR=/data2/sunfanyun/tmp python rl_trainer.py --exp factor-baselines-v1  --env_name $env_name --env_id $env_id --algo $algo --wandb --num_gpus 1 --num_workers 4 --results_dir $results_dir --framework tf2
done
