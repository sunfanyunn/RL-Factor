...
### rl training
python simple_rl_trainer.py --exp simple_flappy_bird_ppo --algo ppo --wandb --num_gpus 1 --num_workers 40 --results_dir /data2/sunfanyun/LLM-Curriculum/results --no-tune
