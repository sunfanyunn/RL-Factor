# iterative_prompts = """Feature a paddle as a rectangular object on the screen.
# The paddle should start at a given position and move horizontally using the left and right arrow keys.
# Feature a ball as a circular object on the screen.
# The ball should start at a given position and move in a random direction.
# The paddle should bounce the ball back when they collide.
# Create bricks and arrange them at the top of the screen.
# When the ball collides with a brick, the brick should disappear, and the ball should bounce back.
# Display the player's score at the top-left corner of the screen, updating it when a brick is destroyed.
# If the ball passes the paddle and reaches the bottom of the screen, end the game.
# After the game ends, display "Game Over!".
# Allow the player to start a new game after the game ends.
# """
