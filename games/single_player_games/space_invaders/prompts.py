iterative_prompts = """
Create a spaceship character, visually represented as a simple triangle, positioned at the bottom and center of the game window. The spaceship should be movable horizontally across the bottom of the screen.
Allow the player to control the spaceship's horizontal movement using the left and right arrow keys on the keyboard.
...
If an alien ship reaches the bottom of the screen without being shot down, end the game.
Display a "Game Over!" message and temporarily halt gameplay.
