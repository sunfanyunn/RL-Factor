...
class Game:
    ...
    def run(self, event):
        ...
        score_surf = self.font.render('Score: %.0f' % self.score, True, WHITE)
...
class Agent(pygame.sprite.Sprite):
    ...
    def apply_thrusters(self, keys):
        ...
        self.velocity = self.velocity - self.velocity * 0.1 # Apply friction/drag
