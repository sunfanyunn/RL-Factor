...
class Pixelcopter(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        # Prevent the Pixelcopter from leaving the screen
        if self.rect.top <= 0:
            self.rect.top = 0
            self.velocity = 0
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, y_pos, height):
        ...
        self.rect = self.image.get_rect(center=(WIDTH + 10, y_pos + height // 2))
        self.rect.x = WIDTH
...
class Game:
    ...
    def spawn_obstacle(self):
        ...
        bottom_obstacle = Obstacle(top_height + CAVERN_WIDTH, HEIGHT - (top_height + CAVERN_WIDTH))
